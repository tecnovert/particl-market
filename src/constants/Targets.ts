...
export const Targets = {
    ...
    Service:     {
        ...
        action: {
            ...
            ChatAddActionService: 'ChatAddActionService',
    ...
    Command:     {
        ...
        chat: {
            ChatRootCommand: 'ChatRootCommand',
            ChatMessagePostCommand: 'ChatMessagePostCommand',
            ChatChannelListCommand: 'ChatChannelListCommand',
            ChatChannelMessagesCommand: 'ChatChannelMessagesCommand',
            ChatChannelSetReadCommand: 'ChatChannelSetReadCommand',
            ChatChannelFollowCommand: 'ChatChannelFollowCommand',
            ChatChannelUnfollowCommand: 'ChatChannelUnfollowCommand',
            ChatParticipantListCommand: 'ChatParticipantListCommand',
            ChatParticipantUpdateCommand: 'ChatParticipantUpdateCommand'
        },
        comment: {
    ...
    MessageProcessor:     {
        action: {
            ...
            ChatAddActionMessageProcessor: 'ChatAddActionMessageProcessor'
        },
